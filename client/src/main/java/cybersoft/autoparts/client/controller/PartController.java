package cybersoft.autoparts.client.controller;
...
import cybersoft.autoparts.library.model.Product;
import cybersoft.autoparts.library.service.CategoryService;
import cybersoft.autoparts.library.service.MakeService;
import cybersoft.autoparts.library.service.ModelService;
import cybersoft.autoparts.library.service.ProductService;
import cybersoft.autoparts.library.util.Utility;
...
public class PartController {
    ...
    public String partSearch(Model model
        ...
        List<cybersoft.autoparts.library.model.Model> listModel = modelService.getModels(Long.parseLong(makeId));
    ...
    public String partDetails(@RequestParam("id") Long id, Model model) {
        ...
        List<cybersoft.autoparts.library.model.Model> listModel = modelService.getModels(listMake.get(0).getId());
        model.addAttribute("listModel", listModel);
