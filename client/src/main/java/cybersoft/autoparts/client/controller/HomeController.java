...
import cybersoft.autoparts.library.model.*;
import cybersoft.autoparts.library.service.*;
...
public class HomeController {
    ...
    public List<Dropdown> getModels(@RequestParam Long make) {
        List<cybersoft.autoparts.library.model.Model> modelList = modelService.getModels(make);
        List<Dropdown> dropdownList=new ArrayList<>();
        for (cybersoft.autoparts.library.model.Model model: modelList) {
